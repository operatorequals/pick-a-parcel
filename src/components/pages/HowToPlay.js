...
<p>Your job is to instruct robots, so they collect <em>Parcels</em> through the <em>Warehouse</em> and deliver them to their <em>Destination</em>.</p>
	...
	<div className="ui-bubble">
<h2 id="whatand39s-in-the-box">What's in the Box?</h2>
<ul>
...
<h5 id="robots-the-parcel-and-the-destination-cannot-be-placed-on-a-non-vacant-position-in-case-this-occurs-a-re-roll-is-done"><em>Robots</em>, the <em>Parcel</em> and the <em>Destination</em> cannot be placed on a non-vacant position. In case this occurs, a re-roll is done.</h5>
<h3 id="a-turn">A Turn</h3>
<h4 id="phase-1-create-your-program">Phase 1: Create your Program</h4>
<ol>
...
<h4 id="phase-2-execution">Phase 2: Execution</h4>
<ol>
...
<div className="ui-bubble">
<h2 id="the-objective---win-lose-and-draw">The Objective - win, lose and draw</h2>
...
<h4 id="a-point-system">A Point System</h4>
...
<div className="ui-bubble">
<h2 id="how-to-create-your-robotand39s-program">How to create your <em>Robot's Program</em></h2>
...
<pre><code>move() - "up" | steal() - "down" | throw() - "right"</code></pre>
...
<div className="ui-bubble">
<h2 id="executing-your-program">Executing your Program</h2>
